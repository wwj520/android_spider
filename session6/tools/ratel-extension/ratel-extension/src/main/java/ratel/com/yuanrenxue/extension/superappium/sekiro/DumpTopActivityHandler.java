...
@Action("dumpActivity")
public class DumpTopActivityHandler implements RequestHandler {
    @AutoBind
        ...
        PageTriggerManager.getMainLooperHandler().post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        RposedHelpers.callMethod(webView, "evaluateJavascript", "document.getElementsByTagName('html')[0].innerHTML", new ValueCallback<String>() {
                            ...
                            public void onReceiveValue(String s) {
                                ...
                                sekiroResponse.send(jsonObject.getString("data"));
                            }
                        });
                    }
                });
            ...
            private void handleNativeDump(ViewImage viewImage) {
                if (!TextUtils.isEmpty(viewHash)) {
                    ...
                    sekiroResponse.success(JSON.parse(SuperAppiumDumper.dumpToJson(collect.get(0))));
                    return;
                    ...
                    for (XNode xNode : xNodes) {
                        if (xNode.isText()) {
                            ...
                            dumpedData.add(SuperAppiumDumper.dumpToJson(xNode.getElement()));
                        }
                    }
